...
//===========================================MongoDB Connection=============================================================
const MONGODB = require('./backend/config/MongoURL')
//const MONGODB_URL = ''


mongoose.connect(encodeURI(MONGODB.MONGODB_URL)).then(() => console.log("***Connection to MongoDB successful***")).catch(err => console.log('***Connection to MongoDB failed***', err))
//================================================================================================================================
